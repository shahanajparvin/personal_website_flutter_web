...
import 'package:personal_website/sections/skill/skill.dart';
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            SlideAnimation(
              animationKey: Keys.skillMenuButton,
              slideDown: true,
              child: MenuButtton(
                dataKey: dataKeys[1],
            ...
            SlideAnimation(
              ...
              child: MenuButtton(
                dataKey: dataKeys[4],
                buttonNumber: ButtonData.buttonNumber5,
                buttonTitle: ButtonData.button5Title,
              ),
            ),
  ...
  Widget _buildContent() {
    return Column(
      ...
      children: <Widget>[
        ...
        Skill(key: dataKeys[1]),
        Work(key: dataKeys[2]),
        Projects(key: dataKeys[3]),
        Footer(key: dataKeys[4]),
      ],
    );
  }
